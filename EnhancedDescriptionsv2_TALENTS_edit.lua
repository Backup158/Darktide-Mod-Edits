...
--[+ +NODES+ +]--
	...
	--[+ Health Boost Low +]--
		create_template("talent_tree_oper_mod_005_l_en", {"loc_talent_health_low"}, {"en"}, function(locale, value) return "Health Boost Small" end),
	...
	--[+ Heavy Melee Damage Boost Low +]--
		create_template("talent_tree_oper_mod_014_l_en", {"loc_talent_melee_heavy_damage_low"}, {"en"}, function(locale, value) return "Heavy Melee Damage Boost Small" end),
	...
	--[+ Melee Damage Boost Low +]--
		create_template("talent_tree_oper_mod_008_en", {"loc_talent_melee_damage_boost_low"}, {"en"}, function(locale, value) return "Melee Damage Boost Small" end),
	...
	--[+ Toughness Boost Low +]--
		create_template("talent_tree_oper_mod_000_l_en", {"loc_talent_toughness_boost_low"}, {"en"}, function(locale, value) return "Toughness Boost Small" end),
...
--[+ +ABILITIES+ +]--
	...
	--[+ Ability 3-2 - Precognition +]--
		create_template("talent_tree_psy_abil3_002_en", {"loc_ability_psyker_overcharge_weakspot"}, {"en"}, function(locale, value) return "Precognition" end),
...
--[+ +PASSIVES+ +]--
	...
	--[+ Passive 21 - Empathic Evasion +]--
		create_template("talent_tree_psy_pas_021_en", {"loc_talent_psyker_dodge_after_crits"}, {"en"}, function(locale, value) return "Empathic Evasion" end),
	...
	--[+ Passive 24 - Puppet Master +]--
		create_template("talent_tree_psy_pas_024_en", {"loc_talent_psyker_coherency_size_increase"}, {"en"}, function(locale, value) return "Puppet Master" end), -- Puppet Master 16 
	...
	create_template("talent_tree_psy_pas_026_en", {"loc_talent_psyker_alternative_peril_explosion"}, {"en"}, function(locale, value) return "Crystalline William" end),
	create_template("talent_tree_psy_pas_026_desc_en", {"loc_talent_psyker_alternative_peril_explosion_desc"}, {"en"}, function(locale, value) return "Overloading through "..COLORS_KWords.Perils_rgb.." of the Warp no longer knocks you down, but you still take the appropriate "..COLORS_KWords.Corruptdmg_rgb.."."..TALENTS_Enh_desc.ED_PSY_Passive_26_rgb end), -- colors

	--[+ Passive 27 - Kinetic Deflection +]--
	create_template("talent_tree_psy_pas_027_en", {"loc_talent_psyker_block_costs_warp_charge"}, {"en"}, function(locale, value) return "Kinetic Deflectionings" end),
...
--[+ +ABILITIES+ +]--
	...
	create_template("talent_tree_zea_abil0_000_en", {"loc_talent_zealot_2_combat"}, {"en"}, function(locale, value) return "Chastise the Motherfuckers" end),
	...
	--[+ Ability 1 - Fury of the Faithful +]--
		create_template("talent_tree_zea_abil1_000_en", {"loc_talent_maniac_attack_speed_after_dash"}, {"en"}, function(locale, value) return "Fury of the Motherfuckers" end),
...
--[+ +KEYSTONES+ +]--
	...
	--[+ Keystone 2 - Martyrdom +]--
		create_template("talent_tree_zea_keys2_000_en", {"loc_talent_zealot_martyrdom"}, {"en"}, function(locale, value) return "Martyrdom" end),
...
--[+ +ABILITIES+ +]--
	...
	--[+ Ability 3-1 - Low Profile +]--
		create_template("talent_tree_vet_abil3_001_en", {"loc_talent_veteran_reduced_threat_after_combat_ability"}, {"en"}, function(locale, value) return "Sneaky Beaky Mode" end),
...
--[+ +KEYSTONES+ +]--
	...
	--[+ Keystone 1-1 - Crack in their Armour +]--
		create_template("talent_tree_vet_keys1_001_en", {"loc_talent_veteran_snipers_focus_rending_bonus"}, {"en"}, function(locale, value) return "Crack in their Armour" end),
