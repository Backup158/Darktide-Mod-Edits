...
--[+ +PASSIVES+ +]--
	...
	create_template("talent_tree_psy_pas_024_en", {"loc_talent_psyker_coherency_size_increase"}, {"en"}, function(locale, value) return "Puppet Master" end),
	...
	--[+ Passive 26 - Crystalline Will +]--
		create_template("talent_tree_psy_pas_026_en", {"loc_talent_psyker_alternative_peril_explosion"}, {"en"}, function(locale, value) return "Crystalline Will" end),
