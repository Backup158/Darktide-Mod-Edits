return {
  ...
  developer_mode_description = {
    en = "Allows you to reload DMF and mods (CTRL+SHIFT+L), gives you access to some debug features.",
    es = "Permite recargar los mods (CTRL+SHIFT+L) y configurar herramientas de depuración.",
    ru = "Позволяет перезагружать DMF и моды (CTRL+SHIFT+L), даёт доступ к инструментам отладки.",
    ["zh-cn"] = "允许重新加载 DMF 和模组（CTRL+SHIFT+L），并启用一些调试功能。",
    ja = "DMFとModのリロード (CTRL+SHIFT+L) や、いくつかのデバッグ機能へのアクセスを可能にします。",
  },
